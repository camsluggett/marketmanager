      ...
      <div class="col-md-8">
        <div class="single-footer-widget">
          <p class="p_footer">
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Market Manager &copy 2018, V1.0
            <a href='./bugs.php'  class="btn" style="margin-right: 8px;" ><i class="fa fa-bug"></i> Bugs</a>
            <br>
          </p>
          <p class="p_footer">
